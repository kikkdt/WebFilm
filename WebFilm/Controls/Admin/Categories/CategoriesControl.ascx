<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CategoriesControl.ascx.cs" Inherits="WebFilm.Controls.Admin.Categories.CategoriesControl" %>
...
<asp:MultiView ID="MultiView1" runat="server">
    <asp:View ID="View1" runat="server">
        <div class="table-responsive table-container">
            ...
            <table
                ...
                <tbody>
                    <asp:Repeater ID="rptCategoriesList" OnItemCommand="rptCategoriesList_ItemCommand" runat="server">
                        <ItemTemplate>
                            <tr>
                                <td><%#:Eval("ID") %></td>
                                <td><%#:Eval("TheLoai") %></td>
            ...
            <div class="modal-dialog modal-fullscreen-md-down">
                <div class="modal-content">
                    ...
                    <div class="modal-body alert alert-danger" role="alert">
                        ...
                        { %>
                        Xoá thể loại này sẽ làm ảnh hưởng <%=this.CountRow %> phim hiện đang liên kết. Bạn có chắn chắn muốn xoá?<%}%>
                    </div>
    ...
    <asp:View ID="View2" runat="server">
        <asp:HiddenField ID="hdCategoriesID" runat="server" />
        ...
        <div class="col-lg-12 layout-spacing  px-3">
            ...
            <div class="row" runat="server">
                <div class="form-floating col-md-6 has-valid">
                    <asp:TextBox ID="txtTheLoai" runat="server" CssClass="form-control is-invalid" placeholder="Thể loại *" />
                    <label for="<%=txtTheLoai.ClientID %>">Thể loại *</label>
                    <asp:CustomValidator ID="validTxtTheLoai" runat="server" ValidateEmptyText="true" ControlToValidate="txtTheLoai" Enabled="true" OnServerValidate="validTxtTheLoai_ServerValidate" ClientValidationFunction="validTxtTheLoai_ClientValidate" CssClass="invalid-tooltip"></asp:CustomValidator>
                </div>
                <div class="form-floating col-md-6 has-valid">
        ...
        <script type="text/javascript">
            ...
            function validTxtTheLoai_ClientValidate(source, args) {
                args.IsValid = true;
                var value = document.getElementById('<%=txtTheLoai.ClientID%>').value;

                if (strRegexEmpty.test(value)) {
                    source.innerHTML = "Nhập thể loại";
                    args.IsValid = false;
                    return;
                }
            }
