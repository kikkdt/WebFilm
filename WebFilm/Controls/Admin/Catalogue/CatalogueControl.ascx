<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CatalogueControl.ascx.cs" Inherits="WebFilm.Controls.Admin.Catalogue.CatalogueControl" %>
...
<asp:MultiView ID="MultiView1" runat="server">
    <asp:View ID="View1" runat="server">
        <div class="table-responsive table-container">
            ...
            <table
                ...
                <tbody>
                    <asp:Repeater ID="rptCatalogueList" OnItemCommand="rptCatalogueList_ItemCommand" runat="server">
                        <ItemTemplate>
                            <tr>
                                <td><%#:Eval("ID") %></td>
                                <td><%#:Eval("DanhMuc") %></td>
            ...
            <div class="modal-dialog modal-fullscreen-md-down">
                <div class="modal-content">
                    ...
                    <div class="modal-body alert alert-danger" role="alert">
                        ...
                        { %>
                        Xoá danh mục này sẽ làm ảnh hưởng <%=this.CountRow %> phim hiện đang liên kết, các phim này sẽ được chuyển thành 'Đang cập nhật'. Bạn có chắn chắn muốn xoá?<%}%>
                    </div>
    ...
    <asp:View ID="View2" runat="server">
        <asp:HiddenField ID="hdCatalogueID" runat="server" />
        ...
        <div class="col-lg-12 layout-spacing  px-3">
            ...
            <div class="row" runat="server">
                <div class="form-floating col-md-6 has-valid">
                    <asp:TextBox ID="txtDanhMuc" runat="server" CssClass="form-control is-invalid" placeholder="Danh mục *" />
                    <label for="<%=txtDanhMuc.ClientID %>">Danh mục *</label>
                    <asp:CustomValidator ID="validTxtDanhMuc" runat="server" ValidateEmptyText="true" ControlToValidate="txtDanhMuc" Enabled="true" OnServerValidate="validTxtDanhMuc_ServerValidate" ClientValidationFunction="validTxtDanhMuc_ClientValidate" CssClass="invalid-tooltip"></asp:CustomValidator>
                </div>
                <div class="form-floating col-md-6 has-valid">
        ...
        <script type="text/javascript">
            ...
            function validTxtDanhMuc_ClientValidate(source, args) {
                args.IsValid = true;
                var value = document.getElementById('<%=txtDanhMuc.ClientID%>').value;

                if (strRegexEmpty.test(value)) {
                    source.innerHTML = "Nhập danh mục";
                    args.IsValid = false;
                    return;
                }
            }
